...
const KnowledgeHub: React.FC<KnowledgeHubProps> = ({ onClose, theme }) => {
  ...
  const videos = [
    ...
    { id: 'y7u8C_L_lXo', title: "How LEDs Work", channel: "Engineering Mindset", cat: "Components", desc: "The deep physics of semiconductors and why they emit light." }, 
    ...
    { id: 'oB0P8V-GfB0', title: "What is Electricity?", channel: "Engineering Mindset", cat: "Science", desc: "The history and discovery of the forces that power our world." }
  ];
